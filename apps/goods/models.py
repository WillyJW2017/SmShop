...
class GoodsCategory(models.Model):
    ...
    desc = models.CharField(default='', max_length=1000, verbose_name='类别描述', help_text='类别描述')
    category_type = models.IntegerField(choices=CATEGORY_TYPE, verbose_name='科目类别',help_text='科目类别')
