# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-06-26 03:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_front_image', models.ImageField(blank=True, null=True, upload_to='', verbose_name='商品封面图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(default='', help_text='类别描述', max_length=1000, verbose_name='类别描述')),
                ('category_type', models.IntegerField(choices=[(1, '一级类目'), (2, '二级类目'), (3, '三级类目')], help_text='科目类别', verbose_name='科目类别')),
